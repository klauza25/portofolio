...
function App() {
  ...
  useEffect(() => {
    const typed = new Typed("#element", {
      strings: ["Développeur web fullstack", "freelancer.", "developpeur Nocode.","fromateur : #Bureatique, #Langues, #Robotique"],
      typeSpeed: 70,
      backSpeed: 50,
      loop: true,
    });
  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ease-in-out ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}>
      {/* Navbar */}
      <div className="navbar  flex justify-between items-center p-4">
        <h1 className="text-3xl   italic">Portfolio</h1>
        ...
        <button
          ...
          className="p-2 rounded-full bg-gray-200 dark:bg-gray-400 hover:bg-gray-300 dark:hover:bg-gray-500 cursor-pointer transition-all duration-300 shadow-md"
        ...
        >
          {darkMode ? (
            ...
            <svg className="h-8 w-8 text-gray-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className=" pt-60 pb-28 md:p-8">
      <div className="  h-screen flex flex-col-reverse lg:flex-row items-center justify-center gap-12 p-10 ">
        <div className="text-left max-w-2xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Bonjour, je suis <span className="text-blue-600 dark:text-blue-400 transition-colors duration-300">Klaus SAMBA</span>
          </h1>
          <div className="h-20 mb-10">
            <span id="element" className="text-3xl md:text-3xl text-blue-600 dark:text-blue-400 transition-colors duration-500"></span>
          </div>
